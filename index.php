...
<div class="container mt-5">
    <div class="row align-items-center">
        <div class="col-lg-6">
            ...
            <p class="text-muted my-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
            <button class="btn btn-order">Mulai Pesan Sekarang</button>
        </div>
        <div class="col-lg-6">
    ...
    <div class="card border-0 bg-transparent">
        ...
        <div class="d-flex align-items-center justify-content-center shadow-sm" 
            ...
            <img src="./assets/images/design-<?= $i ?>.png" 
                 alt="Indah JKT48 Design" 
                 style="width: 47%; /* (115 / 243) * 100 */
                        height: 86%; /* (168 / 194) * 100 */
                        object-fit: cover; 
