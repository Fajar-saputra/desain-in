...
$orders = [];
$stmt = $conn->prepare('SELECT o.*, s.name AS service_name, s.price_design, s.price_print FROM orders o JOIN services s ON s.id = o.service_id WHERE o.user_id = :user_id ORDER BY o.created_at DESC');
